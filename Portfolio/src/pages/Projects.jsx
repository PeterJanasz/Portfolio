    ...
    return (
        <div className="background">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {/* Project Card 1 */}
                <div className="max-w-sm rounded overflow-hidden shadow-lg transform transition-transform hover:scale-105">
                <h1 className="font-bold text-xl mb-2">Movie Ticket Site</h1>
                    ...
                    >
                        <img src="/images/MovieApp.png" alt="Project Image" className="w-full h-auto" />
                    </a>
                ...
                <h1 className="font-bold text-xl mb-2">Recipe App</h1>
                    <a
                        ...
                        rel="noopener noreferrer"
                    >
                        <img src="/images/FoodMakerApp.png" alt="Project Image" className="w-full h-auto" />
                    </a>
                    <div className="px-6 py-4">
                        <p className="text-gray-700 text-base">
                            Project description goes here.
                ...
                <h1 className="font-bold text-xl mb-2">Weather App</h1>
                    <a
                        ...
                        rel="noopener noreferrer"
                    >
                        <img src="/images/weatherApp.png" alt="Project Image" className="w-full h-auto" />
                    </a>
                    <div className="px-6 py-4">
                        <p className="text-gray-700 text-base">
                            Project description goes here.
